...
try: 
    ...
    input2.send_keys("Samoylov")                        
    input3 = browser.find_element_by_css_selector(".first_block .third")
    input3.send_keys("samoylov@mail.ru")                

    # Дальше необязательные поля, их пока не заполняем	
    ...
    # input4.send_keys("127273 г. Москва, ул. Гашика, д. 100500")
